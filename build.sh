...
rm -rf AnyKernel
make O=out ARCH=arm64 lineageos_holland2_defconfig
...
git clone --depth=1 https://github.com/kardebayan/AnyKernel.git -b G AnyKernel
cp out/arch/arm64/boot/Image.gz-dtb AnyKernel
cd AnyKernel
zip -r9 Stormbreaker-holland2-${TANGGAL}.zip *
cd ../
fi
}
compile
